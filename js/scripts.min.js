function capture() {
    html2canvas(document.querySelector("#capture")).then((e) => {
    ...
    function e() {
        ...
        $(".generated").each(function () {
            if (((txtString = $(this).text()), txtString.includes("mondja") && "*" != txtString[0] && txtString.includes("*"))) {
                ...
                var r = 0;
                for (t = 0; t < e.length; t++) "*" == e[t] && (0 == r ? ((e[t] = "<a class='me'>*"), (r = 1)) : ((e[t] = "*<a class='white'>"), (r = 0))), (this.innerHTML = e.join(""));
            }
            if(txtString[11] == "(" || txtString[11] == "|" || txtString[11] == "|" || txtString[11] == "[" || txtString.includes("Loading") || txtString.includes("Loaded") || txtString.includes("[Warning]") || txtString.includes("Bounding Asset") || txtString.includes("===>") || txtString.includes(" [info] ") || txtString.includes(" [V8] ") || txtString.includes("MINUDUMP.") || txtString.includes("Property|") || txtString.includes("Connecting to:") || txtString.includes("natives") || txtString.includes("alt:V") || txtString.includes("natives") || txtString.includes("initialized") || txtString.includes("Initializing") || txtString.includes("items ") || txtString.includes("factions|") || txtString.includes("keysDisabled: ") || txtString.includes("forceHideToggleHUDAndChat") || txtString.includes("Vue") || txtString.includes("vue") || txtString.includes("[Error]") || txtString.includes("Replayinterface") || txtString.includes("Started in") || txtString.includes("Client ") || txtString.includes("Cache ") || txtString.includes("Natives") || txtString.includes("id: ") || txtString.includes("Injected") || txtString.includes("inited") || txtString.includes("Inited") || txtString.includes("production") || txtString.includes(" ms") || txtString.includes("(found") || txtString.includes("Map store") || txtString.includes("Shop|") || txtString.includes("proceedToLogin") || txtString.includes("BASS:") || txtString.includes("Game ") || txtString.includes("Discord manager") || txtString.includes("discordManager") || txtString.includes("resource"))
            {
                this.remove();
                console.log("törölve")
            }
            ...
            {
                this.innerHTML = this.innerHTML.slice(11);
            }
            "*" == txtString[0] || txtString.toLowerCase().indexOf(" *") <= 0 || $(this).addClass("me"),
            txtString.toLowerCase().indexOf(" (( ") >= 0 && $(this).addClass("do"),
            ">" == txtString[0] || txtString.toLowerCase().indexOf(" >") <= 0 || $(this).addClass("ame"),
