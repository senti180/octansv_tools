var changeLogData = ["1.5.29 változásnapló","Az eszköz mostmár skálázza a képeket a megfelelő minőség érdekében"]
...
async function capture() {
    await html2canvas(document.querySelector("#capture"), { backgroundColor: null, scale: 2}).then((e) => {
